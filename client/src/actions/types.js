...
export const UPDATE_TICKET_PARTIAL = 'UPDATE_TICKET_PARTIAL'
...
export const SAVED_TICKET_TYPE = 'SAVED_TICKET_TYPE'

export const SET_AUTH_DATA = 'SET_AUTH_DATA'
export const RESET_AUTH_DATA = 'RESET_AUTH_DATA'
export const AUTH_DATA_LOADING = 'AUTH_DATA_LOADING'

export const OPS_SAVE = 'OPS_SAVE'
export const OPS_SAVE_RESTORE = 'OPS_SAVE_RESTORE'
